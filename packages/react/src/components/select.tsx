...
import { FIELD_CONTROL, FIELD_CONTROL_SIZE, POPUP_SURFACE, POPUP_ITEM, POPUP_ITEM_PICK, POPUP_ITEM_INDENT, POPUP_ITEM_MARKER, POPUP_GROUP_LABEL, POPUP_SEPARATOR } from '../lib/styles';
...
export function SelectOption({ className, children, ...props }: React.ComponentProps<typeof Base.Item>) {
  return (
    <Base.Item className={cn(POPUP_ITEM, POPUP_ITEM_PICK, POPUP_ITEM_INDENT, 'data-selected:font-medium', className)} {...props}>
