 ...
 *   트랙 높이 = --spacing-icon-{size},  너비 = 높이 × 1.8
...
const TRACK: Record<Size, string> = {
  sm: 'h-icon-sm w-[calc(var(--spacing-icon-sm)*1.8)]',
  md: 'h-icon-md w-[calc(var(--spacing-icon-md)*1.8)]',
  lg: 'h-icon-lg w-[calc(var(--spacing-icon-lg)*1.8)]',
};
...
const THUMB: Record<Size, string> = {
  sm: 'size-[calc(var(--spacing-icon-sm)-var(--spacing-inset-xs)*1.5)] translate-x-[calc(var(--spacing-inset-xs)*0.75-var(--border-width-default))] data-checked:translate-x-[calc(var(--spacing-icon-sm)*0.8+var(--spacing-inset-xs)*0.75-var(--border-width-default))]',
  md: 'size-[calc(var(--spacing-icon-md)-var(--spacing-inset-xs)*1.5)] translate-x-[calc(var(--spacing-inset-xs)*0.75-var(--border-width-default))] data-checked:translate-x-[calc(var(--spacing-icon-md)*0.8+var(--spacing-inset-xs)*0.75-var(--border-width-default))]',
  lg: 'size-[calc(var(--spacing-icon-lg)-var(--spacing-inset-xs)*1.5)] translate-x-[calc(var(--spacing-inset-xs)*0.75-var(--border-width-default))] data-checked:translate-x-[calc(var(--spacing-icon-lg)*0.8+var(--spacing-inset-xs)*0.75-var(--border-width-default))]',
};
